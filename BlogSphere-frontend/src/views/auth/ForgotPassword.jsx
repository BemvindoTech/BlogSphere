                    ...
                    <div className="col-lg-5 col-md-8 py-8 py-xl-0">
                        <div className="card shadow">
                            <div className="card-body p-6">
                                <div className="mb-4">
                                    <h1 className="mb-1 fw-bold">Mot de passe oublié</h1>
                                    <span>Nous allons vous aider à recupérer votre compte </span>
                                </div>
                                        ...
                                        <div className="d-grid">
                                            {isLoading === true ? (
                                                ...
                                                <button onClick={handleEmailSubmit} className="btn btn-primary">
                                                    {" "}
                                                    Rénitialiser le mot de passe <i className="fas fa-arrow-right"></i>
                                                </button>
                                            )}
                                        </div>
                                    </div>
