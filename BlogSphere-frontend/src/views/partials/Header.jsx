                                ...
                                <ul className="dropdown-menu" aria-labelledby="pagesMenu">
                                    <li>
                                        <Link className="dropdown-item" to="/about/">
                                            <i className="bi bi-person-lines-fill"></i> A propos
                                        </Link>
                                    </li>
                                    <li>
                            ...
                            <li className="nav-item">
                                ...
                                <>
                                    <Link to={"/dashboard/"} className="btn btn-success" href="dashboard.html">
                                        Tableau de bord <i className="fas fa-dashboard"></i>
                                    </Link>
                                    <Link to={"/logout/"} className="btn btn-success ms-2" href="dashboard.html">
                                        Se déconnecter <i className="fas fa-sign-out-alt"></i>
                                    </Link>
                                </>
                                ) : (
                                <>
                                    ...
                                    <Link to={"/login/"} className="btn btn-success ms-2" href="dashboard.html">
                                        Se connecter <i className="fas fa-sign-in-alt"></i>
                                    </Link>
                                </>)}
