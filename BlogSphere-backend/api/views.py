...
class LikePostAPIView(APIView):
    ...
    def post(self, request):
        ...
        if user in post.likes.all():
            ...
            return Response({"message": "J'aime annulé"}, status=status.HTTP_200_OK)
        else:
            post.likes.add(user)
            ...
            return Response({"message": "publication aimée"}, status=status.HTTP_201_CREATED)
...
class PostCommentAPIView(APIView):
    ...
    def post(self, request):
        ...
        return Response({"message": "Commentaire envoyé"}, status=status.HTTP_201_CREATED)
...
class BookmarkPostAPIView(APIView):
    ...
    def post(self, request):
        ...
        if bookmark:
            ...
            return Response({"message": "Publication épinglé "}, status=status.HTTP_201_CREATED)
...
class DashboardNotificationsList(generics.ListAPIView):
    serializer_class = api_serializer.NotificationSerialize
    permission_classes = [AllowAny]
...
class DashboardMarkNotificationAsSeen(APIView):
    def post(self, request):
        ...
        return Response({"message": "Notification marquée comme vue"},status=status.HTTP_200_OK)
...
class DashboardPostCreateAPIView(generics.CreateAPIView):
    ...
    def create(self, request, *args, **kwargs):
        ...
        return Response({"message": "Publication crée avec succé"},status=status.HTTP_201_CREATED)
...
class DashboardPostEditAPIView(generics.RetrieveUpdateAPIView):
    ...
    def update(self, request, *args, **kwargs):
        ...
        return Response({"message": "Publication mise à jour avec succé"}, status=status.HTTP_201_CREATED)
